...
const PRODUCTION_NAME = 'signal-ens-desktop';
const BETA_NAME = 'signal-ens-desktop-beta';

const PRODUCT_NAME_PATH = 'productName';
const PRODUCTION_PRODUCT_NAME = 'Signal+ENS';
const BETA_PRODUCT_NAME = 'Signal+ENS Beta';

const APP_ID_PATH = 'build.appId';
const PRODUCTION_APP_ID = 'org.whispersystems.signal-ens-desktop';
const BETA_APP_ID = 'org.whispersystems.signal-ens-desktop-beta';

const STARTUP_WM_CLASS_PATH = 'build.linux.desktop.StartupWMClass';
const PRODUCTION_STARTUP_WM_CLASS = 'Signal+ENS';
const BETA_STARTUP_WM_CLASS = 'Signal+ENS Beta';
...
const PRODUCTION_DESKTOP_NAME = 'signal+ens.desktop';
const BETA_DESKTOP_NAME = 'signal+ensbeta.desktop';
